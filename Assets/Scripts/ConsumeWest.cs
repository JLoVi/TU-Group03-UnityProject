...
public class ConsumeWest : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        if (ScoreManager.crystalAmount != 0)
        {
            ...
            Vector3 newposition = new Vector3(step.transform.position.x - WestDistance, step.transform.position.y, step.transform.position.z);
